...
`,ce=n.ZP.div`
  ...
  `,ue=n.ZP.div`
    ...
    display: flex;
    flex-direction: column;
  `;function de({title:e,color:t,width:s,height:n,backgroundImage:i,description:r,onEnterPress:a,onFocus:l}){const{ref:c,focused:u}=W({onEnterPress:a,onFocus:l,extraProps:{title:e,color:t,backgroundImage:i,description:r}});return o.createElement(ue,{ref:c},o.createElement(le,{width:s,height:n,backgroundImage:i,color:t,focused:u}),o.createElement(ce,null,e))}function he({description:e,data:t,title:s,height:n,onAssetPress:i,onSelectAsset:r,onFocus:a}){const{ref:l,focusKey:c}=W({onFocus:a}),u=(0,o.useRef)(null),d=(0,o.useCallback)((({x:e},t)=>{r(t),u.current.scrollTo({left:e,behavior:"smooth"})}),[u]);return o.createElement(_.Provider,{value:c},o.createElement(ne,{ref:l},o.createElement(ie,null,s),o.createElement(re,{ref:u},o.createElement(ae,null,t.map((({title:e,description:t,color:s,backgroundImage:r,width:a},l)=>o.createElement(de,{backgroundImage:r,description:t,height:n,width:a,key:e+l,title:e,color:s,onEnterPress:i,onFocus:d})))))))}const fe=n.ZP.div`
    margin-bottom: 37px;
  `,pe=n.ZP.div`
    color: white;
    margin:8px;
...
`,be=n.ZP.div`
  ...
  `,ve=n.ZP.div`
    ...
    display: flex;
    flex-direction: column;
  `;function xe({title:e,color:t,width:s,height:n,backgroundImage:i,description:r,onEnterPress:a,onFocus:l}){const{ref:c,focused:u}=W({onEnterPress:a,onFocus:l,extraProps:{title:e,color:t,backgroundImage:i,description:r}});return o.createElement(ve,{ref:c},o.createElement(me,{width:s,height:n,backgroundImage:i,color:t,focused:u},o.createElement(be,null,"Asset Title"),o.createElement(pe,null,"Asset text")))}function Ce({description:e,data:t,title:s,height:n,onAssetPress:i,onSelectAsset:r,onFocus:a}){const{ref:l,focusKey:c}=W({onFocus:a}),u=(0,o.useRef)(null),d=(0,o.useCallback)((({x:e},t)=>{r(t),u.current.scrollTo({left:e,behavior:"smooth"})}),[u]);return o.createElement(_.Provider,{value:c},o.createElement(fe,{ref:l},o.createElement(ye,{ref:u},o.createElement(ge,null,t.map((({title:e,description:t,color:s,backgroundImage:r,width:a},l)=>o.createElement(xe,{backgroundImage:"200px"==n?"":r,description:t,height:n,width:a,key:e+l,title:e,color:"200px"==n?"":s,onEnterPress:i,onFocus:d})))))))}const Fe=n.ZP.div`
    position: relative;
    display: flex;
    flex-direction: column;
    align-items: center;
  ...
  `,ke=n.ZP.div`
    ...
    font-weight: 400;
    font-family: 'Arial';
  `,Le=({color:e,backgroundImage:t,title:s,description:n})=>o.createElement(Fe,null,o.createElement(we,{color:e?"red":"#565b6b",backgroundImage:t||""}),o.createElement(Ee,null,o.createElement(Ke,null,s||"Default selected title",o.createElement(Pe,null,n||"Default selected title"),o.createElement(ke,null,'"2nd item of text"')))),Ae=(n.ZP.div`
...
`,n.ZP.div`
  ...
  `),De=n.ZP.div`
    ...
    flex-shrink: 1;
    flex-grow: 1;
  `;function Me(e){let t=[],s=[];e.data&&(t=e.data.pages[0].page.content,s=e.data.spinner[0].page.content);const{setShowContent:n}=(0,o.useContext)(J),{ref:i,focusKey:r}=W(),[a,l]=(0,o.useState)(null),c=(0,o.useCallback)((e=>{n(!0)}),[]),u=(0,o.useCallback)((e=>{l(e)}),[]),d=(0,o.useCallback)((e=>{l(null)}),[]),h=(0,o.useCallback)((({y:e})=>{i.current.scrollTo({top:e,behavior:"smooth"})}),[i]);return o.createElement(_.Provider,{value:r},o.createElement(Ae,null,a?o.createElement(Le,{description:a.description,backgroundImage:a.backgroundImage,title:a.title,color:"",width:""}):o.createElement("div",null),o.createElement(De,{ref:i},t.length>0?o.createElement("div",null,s.map(((e,t,s)=>o.createElement(Ce,{data:e.assets,height:a?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:c,onSelectAsset:d,onFocus:h}))),t.map(((e,t,s)=>o.createElement(he,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:c,onSelectAsset:u,onFocus:h})))):o.createElement("div",null))))}var Be=s(1721),Ne=s(6488),Se=s(1174),Re=s(5945);const Ze=new Ne.S;z({debug:!1,visualDebug:!1});const Ie=n.ZP.div`
...
`;function Oe(){const{isLoading:e,error:t,data:s,refetch:n}=(0,Se.a)(["repoData"],(()=>Be.ZP.get("https://stone-bronzed-river.glitch.me/data.json").then((e=>e.data)))),[i,r]=o.useState(0),[a,l]=o.useState(!1);if(e)return o.createElement("div",null,"Loading...");return o.createElement(J.Provider,{value:{page:i,setPage:r,showContent:a,setShowContent:l}},o.createElement(Ie,null,o.createElement(Te,null),o.createElement(oe,{focusKey:"MENU"}),o.createElement($e,null,o.createElement(Me,{page:i,data:s}))))}class je extends o.Component{constructor(e){super(e)}render(){return o.createElement(Re.aH,{client:Ze},o.createElement(o.StrictMode,null,o.createElement(ze,null,o.createElement(Oe,null))))}}class ze extends o.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(e){return{hasError:!0}}componentDidCatch(e,t){alert(e),window.location.reload()}reload(){window.location.reload()}render(){return this.state.hasError?o.createElement("div",null,o.createElement("h1",null,"Sorry.. there was an error"),o.createElement("button",{onClick:this.reload},"Refresh Page")):this.props.children}}var He=s(745);new class{constructor(){this.render()}render(){(0,He.s)(document.getElementById("app")||document.createElement("div")).render(o.createElement(je,{app:this},null))}}}},s={};function o(e){var n=s[e];if(void 0!==n)return n.exports;var i=s[e]={id:e,loaded:!1,exports:{}};return t[e](i,i.exports,o),i.loaded=!0,i.exports}o.m=t,e=[],o.O=(t,s,n,i)=>{if(!s){var r=1/0;for(u=0;u<e.length;u++){for(var[s,n,i]=e[u],a=!0,l=0;l<s.length;l++)(!1&i||r>=i)&&Object.keys(o.O).every((e=>o.O[e](s[l])))?s.splice(l--,1):(a=!1,i<r&&(r=i));if(a){e.splice(u--,1);var c=n();void 0!==c&&(t=c)}}return t}i=i||0;for(var u=e.length;u>0&&e[u-1][2]>i;u--)e[u]=e[u-1];e[u]=[s,n,i]},o.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return o.d(t,{a:t}),t},o.d=(e,t)=>{for(var s in t)o.o(t,s)&&!o.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},o.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(e){if("object"==typeof window)return window}}(),o.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),o.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},o.nmd=e=>(e.paths=[],e.children||(e.children=[]),e),(()=>{var e={179:0};o.O.j=t=>0===e[t];var t=(t,s)=>{var n,i,[r,a,l]=s,c=0;if(r.some((t=>0!==e[t]))){for(n in a)o.o(a,n)&&(o.m[n]=a[n]);if(l)var u=l(o)}for(t&&t(s);c<r.length;c++)i=r[c],o.o(e,i)&&e[i]&&e[i][0](),e[i]=0;return o.O(u)},s=self.webpackChunkreact_typescript_webpack_starter=self.webpackChunkreact_typescript_webpack_starter||[];s.forEach(t.bind(null,0)),s.push=t.bind(null,s.push.bind(s))})(),o.nc=void 0,o.O(void 0,[675],(()=>o(4810)));var n=o.O(void 0,[675],(()=>o(1941)));n=o.O(n)})();