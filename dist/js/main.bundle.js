...
`,de=n.ZP.div`
  ...
  `,he=n.ZP.div`
    ...
    display: flex;
    flex-direction: column;
  `;function pe({id:e,title:t,color:s,width:n,height:i,backgroundImage:r,key:a,description:l,onEnterPress:c,onFocus:u}){const{ref:d,focused:h}=J({onEnterPress:c,onFocus:u,focusKey:a,extraProps:{id:e,title:t,color:s,backgroundImage:r,description:l}});return o.createElement(he,{ref:d},o.createElement(ue,{width:n,height:i,key:a,backgroundImage:r,color:s,focused:h}),o.createElement(de,null,e," - ",t))}function fe({description:e,data:t,title:s,height:n,onAssetPress:i,onSelectAsset:r,onFocus:a}){const{ref:l,focusKey:c}=J({onFocus:a}),u=(0,o.useRef)(null),d=(0,o.useCallback)((({x:e},t)=>{r(t),u.current.scrollTo({left:e,behavior:"smooth"})}),[u]);return o.createElement(q.Provider,{value:c},o.createElement(re,{ref:l},o.createElement(ae,null,s),o.createElement(le,{ref:u},o.createElement(ce,null,t.map((({id:e,title:t,description:s,color:r,backgroundImage:a,width:l},c)=>o.createElement(pe,{backgroundImage:a,description:s,height:n,width:l,id:e,key:t+c,title:t,color:r,onEnterPress:i,onFocus:d})))))))}const ge=n.ZP.div`
    margin-bottom: 37px;
  `,ye=n.ZP.div`
    color: white;
    margin:8px;
...
`),Re=n.ZP.div`
  ...
  `,Ie=n.ZP.div`
    ...
    flex-shrink: 1;
    flex-grow: 1;
  `;function Ze(e){let t=[],s=[],n=[];const{setshowMenu:i,id:r,setId:a,setPage:l,page:c}=(0,o.useContext)(X),{ref:u,focusKey:d,focusSelf:h,getCurrentFocusKey:p,setFocus:f}=J({saveLastFocusedChild:!0});e.data&&e.page<2&&(t=e.data.pages[e.page].page.content,s=e.data.spinner[e.page].page.content,n=[],n.push({assets:[{title:e.data.pages[0].page.content[0].assets[r].title,color:"#000000",backgroundImage:e.data.pages[0].page.content[0].assets[r].backgroundImage,width:"1920px",height:"700px",description:e.data.pages[0].page.content[0].assets[r].description}]}));let g=(0,o.useRef)(0),y=(0,o.useRef)("");(0,o.useEffect)((()=>{const e=({key:e})=>{if("Backspace"==e||"XF86Back"==e){let e=g.current;alert(e),0==e&&1==confirm("Exit the application?")&&window.tizen.application.getCurrentApplication().exit(),e--,e<0&&(e=0),l(e),g.current=e}};return window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}}),[]);const[m,b]=(0,o.useState)(null),v=t=>{0==e.page?(l(1),g.current=1,y.current=p(),f("spinner:0")):(l(2),g.current=2,y.current=p())},x=(0,o.useCallback)((t=>{0==e.page?(l(1),a(t.id),g.current=1,y.current=p(),f("spinner:0")):(l(2),g.current=2,y.current=p())}),[]),w=e=>{b(e)},C=(0,o.useCallback)((e=>{b(null)}),[]),F=(0,o.useCallback)((({y:e})=>{u.current.scrollTo({top:e,behavior:"smooth"})}),[u]);switch(e.page){case 0:return o.createElement(q.Provider,{value:d},2==e.page?o.createElement(Se,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}):null,o.createElement(Re,null,m?o.createElement(Ne,{description:m.description,backgroundImage:m.backgroundImage,title:r+" - "+m.title,color:"",width:""}):o.createElement("div",null),o.createElement(Ie,{ref:u},o.createElement("div",null,s.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:m?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:v,onSelectAsset:C,onFocus:F}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:x,onSelectAsset:w,onFocus:F})))))));case 1:return o.createElement(q.Provider,{value:d},o.createElement(Re,null,m?o.createElement(Ne,{description:m.description,backgroundImage:m.backgroundImage,title:m.title,color:"",width:""}):o.createElement("div",null),o.createElement(Ie,{ref:u},o.createElement("div",null,n.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:m?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:v,onSelectAsset:C,onFocus:F}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:x,onSelectAsset:w,onFocus:F})))))));case 2:return o.createElement(q.Provider,{value:d},o.createElement(Se,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}))}}var $e=s(1721),Oe=s(6488),ze=s(1174),Te=s(5945);const je=new Oe.S;H({debug:!1,visualDebug:!1});const He=n.ZP.div`
  background-color: #000000;
  width: 1920px;
  height: 1080px;
  display: flex;
...
`;function qe(){const{isLoading:e,error:t,data:s,refetch:n}=(0,ze.a)(["repoData"],(()=>$e.ZP.get("https://stone-bronzed-river.glitch.me/data.json").then((e=>e.data)))),[i,r]=o.useState(0),[a,l]=o.useState(0),[c,u]=o.useState(!0);return e?o.createElement("div",null,"Loading..."):o.createElement(X.Provider,{value:{page:i,setPage:r,id:a,setId:l,showMenu:c,setshowMenu:u}},o.createElement(He,null,o.createElement(_e,null),0==i?o.createElement(ie,{focusKey:"MENU"}):null,o.createElement(Ue,null,o.createElement(Ze,{id:a,page:i,data:s}))))}class We extends o.Component{constructor(e){super(e)}render(){return o.createElement(Te.aH,{client:je},o.createElement(o.StrictMode,null,o.createElement(Je,null,o.createElement(qe,null))))}}class Je extends o.Component{constructor(){super(...arguments),this.state={hasError:!1}}static getDerivedStateFromError(e){return{hasError:!0}}componentDidCatch(e,t){alert(e),window.location.reload()}reload(){window.location.reload()}render(){return this.state.hasError?o.createElement("div",null,o.createElement("h1",null,"Sorry.. there was an error"),o.createElement("button",{onClick:this.reload},"Refresh Page")):this.props.children}}var Xe=s(745);new class{constructor(){this.render()}render(){(0,Xe.s)(document.getElementById("app")||document.createElement("div")).render(o.createElement(We,{app:this},null))}}}},s={};function o(e){var n=s[e];if(void 0!==n)return n.exports;var i=s[e]={id:e,loaded:!1,exports:{}};return t[e](i,i.exports,o),i.loaded=!0,i.exports}o.m=t,e=[],o.O=(t,s,n,i)=>{if(!s){var r=1/0;for(u=0;u<e.length;u++){for(var[s,n,i]=e[u],a=!0,l=0;l<s.length;l++)(!1&i||r>=i)&&Object.keys(o.O).every((e=>o.O[e](s[l])))?s.splice(l--,1):(a=!1,i<r&&(r=i));if(a){e.splice(u--,1);var c=n();void 0!==c&&(t=c)}}return t}i=i||0;for(var u=e.length;u>0&&e[u-1][2]>i;u--)e[u]=e[u-1];e[u]=[s,n,i]},o.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return o.d(t,{a:t}),t},o.d=(e,t)=>{for(var s in t)o.o(t,s)&&!o.o(e,s)&&Object.defineProperty(e,s,{enumerable:!0,get:t[s]})},o.g=function(){if("object"==typeof globalThis)return globalThis;try{return this||new Function("return this")()}catch(e){if("object"==typeof window)return window}}(),o.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),o.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},o.nmd=e=>(e.paths=[],e.children||(e.children=[]),e),(()=>{var e={179:0};o.O.j=t=>0===e[t];var t=(t,s)=>{var n,i,[r,a,l]=s,c=0;if(r.some((t=>0!==e[t]))){for(n in a)o.o(a,n)&&(o.m[n]=a[n]);if(l)var u=l(o)}for(t&&t(s);c<r.length;c++)i=r[c],o.o(e,i)&&e[i]&&e[i][0](),e[i]=0;return o.O(u)},s=self.webpackChunkreact_typescript_webpack_starter=self.webpackChunkreact_typescript_webpack_starter||[];s.forEach(t.bind(null,0)),s.push=t.bind(null,s.push.bind(s))})(),o.nc=void 0,o.O(void 0,[675],(()=>o(4810)));var n=o.O(void 0,[675],(()=>o(1941)));n=o.O(n)})();