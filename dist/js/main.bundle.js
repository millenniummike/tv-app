...
`,de=n.ZP.div`
  ...
  `,he=n.ZP.div`
    ...
    display: flex;
    flex-direction: column;
  `;function pe({title:e,color:t,width:s,height:n,backgroundImage:i,key:r,description:a,onEnterPress:l,onFocus:c}){const{ref:u,focused:d}=X({onEnterPress:l,onFocus:c,focusKey:r,extraProps:{title:e,color:t,backgroundImage:i,description:a}});return o.createElement(he,{ref:u},o.createElement(ue,{width:s,height:n,key:r,backgroundImage:i,color:t,focused:d}),o.createElement(de,null,e))}function fe({description:e,data:t,title:s,height:n,onAssetPress:i,onSelectAsset:r,onFocus:a}){const{ref:l,focusKey:c}=X({onFocus:a}),u=(0,o.useRef)(null),d=(0,o.useCallback)((({x:e},t)=>{r(t),u.current.scrollTo({left:e,behavior:"smooth"})}),[u]);return o.createElement(q.Provider,{value:c},o.createElement(re,{ref:l},o.createElement(ae,null,s),o.createElement(le,{ref:u},o.createElement(ce,null,t.map((({title:e,description:t,color:s,backgroundImage:r,width:a},l)=>o.createElement(pe,{backgroundImage:r,description:t,height:n,width:a,key:e+l,title:e,color:s,onEnterPress:i,onFocus:d})))))))}const ye=n.ZP.div`
    margin-bottom: 37px;
  `,ge=n.ZP.div`
    color: white;
    margin:8px;
...
`,we=n.ZP.div`
  ...
  `,Ee=n.ZP.div`
    ...
    display: flex;
    flex-direction: column;
  `;function Ke({title:e,color:t,width:s,height:n,backgroundImage:i,description:r,id:a,onEnterPress:l,onFocus:c}){const[u,d]=(0,o.useState)(!0),{ref:h,focused:p}=X({onEnterPress:l,onFocus:c,focusKey:a,extraProps:{title:e,color:t,backgroundImage:i,description:r,fadeIn:()=>{d(!0)},fadeOut:()=>{d(!1)}}});return o.createElement(Ee,{ref:h},u?o.createElement(Fe,{width:s,height:n,backgroundImage:i,color:t,focused:p},o.createElement(we,null,"Asset Title"),o.createElement(ge,null,"Asset text")):o.createElement(Ce,{width:s,height:n,backgroundImage:i,color:t,focused:p},o.createElement(we,null,"Asset Title"),o.createElement(ge,null,"Asset text")))}function ke({description:e,data:t,title:s,height:n,onAssetPress:i,onSelectAsset:r,onFocus:a}){const{ref:l,focusKey:c}=X({onFocus:a}),u=()=>{},d=()=>{},h=(0,o.useRef)(null);let p=null;const f=(0,o.useCallback)((({x:e},t)=>{h.current.scrollLeft!=e&&(t.fadeIn(),p&&p.fadeOut(),h.current.scrollTo({left:e,behavior:"smooth"})),p=t,r(t)}),[h]);return o.createElement(q.Provider,{value:c},o.createElement(ye,{ref:l},o.createElement(me,{ref:h},o.createElement(be,null,t.map((({title:e,description:t,color:s,backgroundImage:r,width:a},l)=>o.createElement(Ke,{backgroundImage:"200px"==n?"":r,description:t,height:n,width:a,id:"spinner:"+l,key:e+l,title:e,color:"200px"==n?"":s,onEnterPress:i,onFocus:f,fadeIn:u,fadeOut:d})))))))}const Pe=n.ZP.div`
    position: relative;
    display: flex;
    flex-direction: column;
    align-items: center;
  ...
  `,De=n.ZP.div`
    ...
    font-weight: 400;
    font-family: 'Arial';
  `,Se=({color:e,backgroundImage:t,title:s,description:n})=>o.createElement(Pe,null,o.createElement(Le,{color:e?"red":"#565b6b",backgroundImage:t||""}),o.createElement(Ae,null,o.createElement(Me,null,s||"Default selected title",o.createElement(Be,null,n||"Default selected title"),o.createElement(De,null,'"2nd item of text"')))),Ne=(n.ZP.div`
...
`),Re=n.ZP.div`
  ...
  `,Ie=n.ZP.div`
    ...
    flex-shrink: 1;
    flex-grow: 1;
  `;function Ze(e){let t=[],s=[];e.data&&e.page<2&&(t=e.data.pages[e.page].page.content,s=e.data.spinner[e.page].page.content);const{setshowMenu:n,setPage:i,page:r}=(0,o.useContext)(Y),{ref:a,focusKey:l,focusSelf:c,getCurrentFocusKey:u,setFocus:d}=X({saveLastFocusedChild:!0});let h=(0,o.useRef)(0),p=(0,o.useRef)("");(0,o.useEffect)((()=>{const e=({key:e})=>{if(alert(e),"XF86Back"==e&&alert("YES!"),"Backspace"==e||"XF86Back"==e){alert("Back");let e=h.current;e--,e<0&&(e=0),i(e),h.current=e}};return window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}}),[]);const[f,y]=(0,o.useState)(null),g=t=>{0==e.page?(i(1),h.current=1,p.current=u(),d("spinner:0")):(i(2),h.current=2,p.current=u())},m=(0,o.useCallback)((t=>{0==e.page?(i(1),h.current=1,p.current=u(),d("spinner:0")):(i(2),h.current=2,p.current=u())}),[]),b=e=>{y(e)},v=(0,o.useCallback)((e=>{y(null)}),[]),x=(0,o.useCallback)((({y:e})=>{a.current.scrollTo({top:e,behavior:"smooth"})}),[a]);switch(e.page){case 0:return o.createElement(q.Provider,{value:l},2==e.page?o.createElement(Ne,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}):null,o.createElement(Re,null,f?o.createElement(Se,{description:f.description,backgroundImage:f.backgroundImage,title:f.title,color:"",width:""}):o.createElement("div",null),o.createElement(Ie,{ref:a},o.createElement("div",null,s.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:f?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:g,onSelectAsset:v,onFocus:x}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:m,onSelectAsset:b,onFocus:x})))))));case 1:return o.createElement(q.Provider,{value:l},o.createElement(Re,null,f?o.createElement(Se,{description:f.description,backgroundImage:f.backgroundImage,title:f.title,color:"",width:""}):o.createElement("div",null),o.createElement("div",null,"Specific Selected Content"),o.createElement(Ie,{ref:a},o.createElement("div",null,s.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:f?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:g,onSelectAsset:v,onFocus:x}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:m,onSelectAsset:b,onFocus:x})))))));case 2:return o.createElement(q.Provider,{value:l},o.createElement(Ne,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}))}}var $e=s(1721),Oe=s(6488),Te=s(1174),ze=s(5945);const je=new Oe.S;H({debug:!0,visualDebug:!1});const He=n.ZP.div`
  background-color: #000000;
  width: 1920px;
  height: 1080px;
  display: flex;
