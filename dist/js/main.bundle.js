...
`),Re=n.ZP.div`
  ...
  `,Ie=n.ZP.div`
    ...
    flex-shrink: 1;
    flex-grow: 1;
  `;function Ze(e){let t=[],s=[];e.data&&e.page<2&&(t=e.data.pages[e.page].page.content,s=e.data.spinner[e.page].page.content);const{setshowMenu:n,setPage:i,page:r}=(0,o.useContext)(Y),{ref:a,focusKey:l,focusSelf:c,getCurrentFocusKey:u,setFocus:d}=J({saveLastFocusedChild:!0});let h=(0,o.useRef)(0),p=(0,o.useRef)("");(0,o.useEffect)((()=>{const e=({key:e})=>{if("Backspace"==e){let e=h.current;e--,e<0&&(e=0),i(e),h.current=e;setTimeout((()=>{}),1e3)}};return window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}}),[]);const[f,y]=(0,o.useState)(null),g=t=>{0==e.page?(i(1),h.current=1,p.current=u(),d("spinner:0")):(i(2),h.current=2,p.current=u())},m=(0,o.useCallback)((t=>{0==e.page?(i(1),h.current=1,p.current=u(),d("spinner:0")):(i(2),h.current=2,p.current=u())}),[]),b=e=>{y(e)},v=(0,o.useCallback)((e=>{y(null)}),[]),x=(0,o.useCallback)((({y:e})=>{a.current.scrollTo({top:e,behavior:"smooth"})}),[a]);switch(e.page){case 0:return o.createElement(q.Provider,{value:l},2==e.page?o.createElement(Se,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}):null,o.createElement(Re,null,f?o.createElement(Ne,{description:f.description,backgroundImage:f.backgroundImage,title:f.title,color:"",width:""}):o.createElement("div",null),o.createElement(Ie,{ref:a},o.createElement("div",null,s.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:f?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:g,onSelectAsset:v,onFocus:x}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:m,onSelectAsset:b,onFocus:x})))))));case 1:return o.createElement(q.Provider,{value:l},o.createElement(Re,null,f?o.createElement(Ne,{description:f.description,backgroundImage:f.backgroundImage,title:f.title,color:"",width:""}):o.createElement("div",null),o.createElement("div",null,"Specific Selected Content"),o.createElement(Ie,{ref:a},o.createElement("div",null,s.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:f?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:g,onSelectAsset:v,onFocus:x}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:m,onSelectAsset:b,onFocus:x})))))));case 2:return o.createElement(q.Provider,{value:l},o.createElement(Se,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}))}}var $e=s(1721),Oe=s(6488),Te=s(1174),ze=s(5945);const je=new Oe.S;H({debug:!0,visualDebug:!1});const He=n.ZP.div`
  background-color: #000000;
  width: 1920px;
  height: 1080px;
  display: flex;
