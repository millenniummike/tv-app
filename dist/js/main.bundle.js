...
`),Re=n.ZP.div`
  ...
  `,Ie=n.ZP.div`
    ...
    flex-shrink: 1;
    flex-grow: 1;
  `;function Ze(e){let t=[],s=[],n=[];const{setshowMenu:i,id:r,setId:a,setPage:l,page:c}=(0,o.useContext)(X),{ref:u,focusKey:d,focusSelf:h,getCurrentFocusKey:p,setFocus:f}=J({saveLastFocusedChild:!0});e.data&&e.page<2&&(t=e.data.pages[e.page].page.content,s=e.data.spinner[e.page].page.content,n=[],n.push({assets:[{title:e.data.pages[0].page.content[0].assets[r].title,color:"#000000",backgroundImage:e.data.pages[0].page.content[0].assets[r].backgroundImage,width:"1920px",height:"700px",description:e.data.pages[0].page.content[0].assets[r].description}]}));let g=(0,o.useRef)(0),y=(0,o.useRef)("");(0,o.useEffect)((()=>{const e=({key:e})=>{if("Backspace"==e||"XF86Back"==e){let e=g.current;e--,e<0&&(e=0),l(e),g.current=e}};return window.addEventListener("keydown",e),()=>{window.removeEventListener("keydown",e)}}),[]);const[m,b]=(0,o.useState)(null),v=t=>{0==e.page?(l(1),g.current=1,y.current=p(),f("spinner:0")):(l(2),g.current=2,y.current=p())},x=(0,o.useCallback)((t=>{0==e.page?(l(1),a(t.id),g.current=1,y.current=p(),f("spinner:0")):(l(2),g.current=2,y.current=p())}),[]),w=e=>{b(e)},F=(0,o.useCallback)((e=>{b(null)}),[]),C=(0,o.useCallback)((({y:e})=>{u.current.scrollTo({top:e,behavior:"smooth"})}),[u]);switch(e.page){case 0:return o.createElement(q.Provider,{value:d},2==e.page?o.createElement(Se,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}):null,o.createElement(Re,null,m?o.createElement(Ne,{description:m.description,backgroundImage:m.backgroundImage,title:r+" - "+m.title,color:"",width:""}):o.createElement("div",null),o.createElement(Ie,{ref:u},o.createElement("div",null,s.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:m?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:v,onSelectAsset:F,onFocus:C}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:x,onSelectAsset:w,onFocus:C})))))));case 1:return o.createElement(q.Provider,{value:d},o.createElement(Re,null,m?o.createElement(Ne,{description:m.description,backgroundImage:m.backgroundImage,title:m.title,color:"",width:""}):o.createElement("div",null),o.createElement(Ie,{ref:u},o.createElement("div",null,n.map(((e,t,s)=>o.createElement(ke,{data:e.assets,height:m?"200px":"600px",key:e.title+t,title:e.title,description:e.description,onAssetPress:v,onSelectAsset:F,onFocus:C}))),t.map(((e,t,s)=>o.createElement(fe,{height:"200px",data:e.assets,key:e.title+t,title:e.title,description:e.description,onAssetPress:x,onSelectAsset:w,onFocus:C})))))));case 2:return o.createElement(q.Provider,{value:d},o.createElement(Se,{id:"video",src:"http://techslides.com/demos/sample-videos/small.mp4",loop:!0,autoPlay:!0,preload:"auto"}))}}var $e=s(1721),Oe=s(6488),ze=s(1174),Te=s(5945);const je=new Oe.S;H({debug:!1,visualDebug:!1});const He=n.ZP.div`
  background-color: #000000;
  width: 1920px;
  height: 1080px;
  display: flex;
